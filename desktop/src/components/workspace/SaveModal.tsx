  ...
  const { t } = useTranslation();
    ...
    return (
        <div className="fixed inset-0 z-modal flex items-center justify-center bg-black/60 backdrop-blur-sm animate-in fade-in duration-200">
            <div role="dialog" aria-modal="true" aria-label={t('misc.save:luu_thanh_pdf')} className="bg-[#f3f4f6] dark:bg-[#1a1a1a] rounded shadow-2xl flex flex-col w-[800px] h-[580px] overflow-hidden border border-black/20 dark:border-white/10 animate-in zoom-in-95 duration-200">
