...
export const TOOL_REGISTRY: ToolDefinition[] = [
  ...
  {
    id: 'imposition',
    title: 'Nắn thẻ – Làm trắng scan',
    tabTitle: 'Nắn thẻ – Làm trắng scan',
    icon: '🪪',
    description: 'Nắn ảnh giấy tờ chụp xiên, làm sạch nền xám của bản scan',
    longDescription: 'Tự tìm bốn góc CCCD, CMND, thẻ bảo hiểm để nắn trực diện; đồng thời làm trắng nền scan theo chế độ giữ màu, xám hoặc đen trắng. Xử lý cục bộ trên máy.',
    category: 'image',
    component: ImpositionTab,
    isEnabled: true,
    featureId: 'util.document_cleanup',
    defaultPayload: { focusFeature: 'document_cleanup' },
    hoverColor: 'hover:border-violet-500 hover:text-violet-600 text-slate-800 dark:text-white',
    hoverBorder: 'hover:border-violet-500',
    hoverShadow: 'hover:shadow-[0_8px_30px_rgb(139,92,246,0.15)]',
    bgIcon: 'bg-violet-100 dark:bg-violet-500/10',
