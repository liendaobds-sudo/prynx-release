...
export const TOOL_REGISTRY: ToolDefinition[] = [
  ...
  {
    id: 'imposition',
    title: 'Ghép file (Merge)',
    tabTitle: 'Bình bài (Chưa có file)',
    icon: '🔗',
    description: 'Gộp nhiều file, trộn lẻ chẵn',
    longDescription: 'Gộp nhiều file, trộn trang lẻ chẵn xen kẽ.',
    category: 'file',
    component: ImpositionTab,
    isEnabled: true,
    defaultPayload: { focusFeature: 'merge' },
  ...
  {
    id: 'imposition',
    title: 'Đóng Số & Chữ (Stick)',
    tabTitle: 'Bình bài (Chưa có file)',
    icon: '🔠',
    description: 'Chèn Text / Đánh số cố định trang',
    longDescription: 'Đóng dấu số nhảy hoặc chữ cố định vào tọa độ trang (Clone Quite Imposing).',
    category: 'file',
    component: ImpositionTab,
    isEnabled: true,
  ...
  {
    id: 'combine_pdf',
    title: 'Ghép nối PDF (Combine)',
    tabTitle: 'Ghép nối (Combine)',
    icon: '📑',
    description: 'Ghép nhiều file thành 1 file duy nhất',
    longDescription: 'Sắp xếp thứ tự trực quan và ghép nhiều tệp PDF lại thành 1 file duy nhất một cách nhanh chóng.',
    category: 'util',
...
export const TOOL_KEYWORDS: Record<string, string> = {
  ...
  stick_text_number: 'stamp text number stick dong dau chu so chen text co dinh quite imposing',
  // Imposition
  ...
  // QC / standalone
  combine_pdf: 'combine merge join concat ghep noi gop file',
