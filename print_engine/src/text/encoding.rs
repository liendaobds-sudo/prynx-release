...
pub const WIN_ANSI: &[Entry] = &[
    ...
    (33, "exclam", 0x0021),
    (34, "quotedbl", 0x0022),
    (35, "numbersign", 0x0023),
    (36, "dollar", 0x0024),
    (37, "percent", 0x0025),
    (38, "ampersand", 0x0026),
    (39, "quotesingle", 0x0027),
    (40, "parenleft", 0x0028),
    (41, "parenright", 0x0029),
    (42, "asterisk", 0x002A),
    (43, "plus", 0x002B),
    (44, "comma", 0x002C),
    (45, "hyphen", 0x002D),
    ...
    (89, "Y", 0x0059),
    (90, "Z", 0x005A),
    (91, "bracketleft", 0x005B),
    (92, "backslash", 0x005C),
    (93, "bracketright", 0x005D),
    (94, "asciicircum", 0x005E),
    (95, "underscore", 0x005F),
    (96, "grave", 0x0060),
    (97, "a", 0x0061),
    (98, "b", 0x0062),
    (99, "c", 0x0063),
    ...
    (121, "y", 0x0079),
    (122, "z", 0x007A),
    (123, "braceleft", 0x007B),
    (124, "bar", 0x007C),
    (125, "braceright", 0x007D),
    (126, "asciitilde", 0x007E),
    (128, "Euro", 0x20AC),
    (130, "quotesinglbase", 0x201A),
    (131, "florin", 0x0192),
    (132, "quotedblbase", 0x201E),
    (133, "ellipsis", 0x2026),
    (134, "dagger", 0x2020),
    (135, "daggerdbl", 0x2021),
    (136, "circumflex", 0x02C6),
    (137, "perthousand", 0x2030),
    (138, "Scaron", 0x0160),
    (139, "guilsinglleft", 0x2039),
    (140, "OE", 0x0152),
    (142, "Zcaron", 0x017D),
    (145, "quoteleft", 0x2018),
    (146, "quoteright", 0x2019),
    (147, "quotedblleft", 0x201C),
    (148, "quotedblright", 0x201D),
    (149, "bullet", 0x2022),
    (150, "endash", 0x2013),
    (151, "emdash", 0x2014),
    (152, "tilde", 0x02DC),
    (153, "trademark", 0x2122),
    (154, "scaron", 0x0161),
    (155, "guilsinglright", 0x203A),
    (156, "oe", 0x0153),
    (158, "zcaron", 0x017E),
    (159, "Ydieresis", 0x0178),
    (160, "space", 0x00A0),
    ...
    (164, "currency", 0x00A4),
    (165, "yen", 0x00A5),
    (166, "brokenbar", 0x00A6),
    (167, "section", 0x00A7),
    (168, "dieresis", 0x00A8),
    (169, "copyright", 0x00A9),
    (170, "ordfeminine", 0x00AA),
    (171, "guillemotleft", 0x00AB),
    (172, "logicalnot", 0x00AC),
    (173, "hyphen", 0x00AD),
    (174, "registered", 0x00AE),
    (175, "macron", 0x00AF),
    (176, "degree", 0x00B0),
    (177, "plusminus", 0x00B1),
    (178, "twosuperior", 0x00B2),
    (179, "threesuperior", 0x00B3),
    (180, "acute", 0x00B4),
    (181, "mu", 0x00B5),
    (182, "paragraph", 0x00B6),
    (183, "periodcentered", 0x00B7),
    (184, "cedilla", 0x00B8),
    (185, "onesuperior", 0x00B9),
    (186, "ordmasculine", 0x00BA),
    (187, "guillemotright", 0x00BB),
    (188, "onequarter", 0x00BC),
    (189, "onehalf", 0x00BD),
    (190, "threequarters", 0x00BE),
    (191, "questiondown", 0x00BF),
    (192, "Agrave", 0x00C0),
    (193, "Aacute", 0x00C1),
    (194, "Acircumflex", 0x00C2),
    (195, "Atilde", 0x00C3),
    (196, "Adieresis", 0x00C4),
    (197, "Aring", 0x00C5),
    (198, "AE", 0x00C6),
    (199, "Ccedilla", 0x00C7),
    (200, "Egrave", 0x00C8),
    (201, "Eacute", 0x00C9),
    (202, "Ecircumflex", 0x00CA),
    (203, "Edieresis", 0x00CB),
    (204, "Igrave", 0x00CC),
    (205, "Iacute", 0x00CD),
    (206, "Icircumflex", 0x00CE),
    (207, "Idieresis", 0x00CF),
    (208, "Eth", 0x00D0),
    (209, "Ntilde", 0x00D1),
    (210, "Ograve", 0x00D2),
    (211, "Oacute", 0x00D3),
    (212, "Ocircumflex", 0x00D4),
    (213, "Otilde", 0x00D5),
    (214, "Odieresis", 0x00D6),
    (215, "multiply", 0x00D7),
    (216, "Oslash", 0x00D8),
    (217, "Ugrave", 0x00D9),
    (218, "Uacute", 0x00DA),
    (219, "Ucircumflex", 0x00DB),
    (220, "Udieresis", 0x00DC),
    (221, "Yacute", 0x00DD),
    (222, "Thorn", 0x00DE),
    (223, "germandbls", 0x00DF),
    (224, "agrave", 0x00E0),
    (225, "aacute", 0x00E1),
    (226, "acircumflex", 0x00E2),
    (227, "atilde", 0x00E3),
    (228, "adieresis", 0x00E4),
    (229, "aring", 0x00E5),
    (230, "ae", 0x00E6),
    (231, "ccedilla", 0x00E7),
    (232, "egrave", 0x00E8),
    (233, "eacute", 0x00E9),
    (234, "ecircumflex", 0x00EA),
    (235, "edieresis", 0x00EB),
    (236, "igrave", 0x00EC),
    (237, "iacute", 0x00ED),
    (238, "icircumflex", 0x00EE),
    (239, "idieresis", 0x00EF),
    (240, "eth", 0x00F0),
    (241, "ntilde", 0x00F1),
    (242, "ograve", 0x00F2),
    (243, "oacute", 0x00F3),
    (244, "ocircumflex", 0x00F4),
    (245, "otilde", 0x00F5),
    (246, "odieresis", 0x00F6),
    (247, "divide", 0x00F7),
    (248, "oslash", 0x00F8),
    (249, "ugrave", 0x00F9),
    (250, "uacute", 0x00FA),
    (251, "ucircumflex", 0x00FB),
    (252, "udieresis", 0x00FC),
    (253, "yacute", 0x00FD),
    (254, "thorn", 0x00FE),
    (255, "ydieresis", 0x00FF),
];
...
pub const MAC_ROMAN: &[Entry] = &[
    (128, "Adieresis", 0x00C4),
    (129, "Aring", 0x00C5),
    (130, "Ccedilla", 0x00C7),
    (131, "Eacute", 0x00C9),
    (132, "Ntilde", 0x00D1),
    (133, "Odieresis", 0x00D6),
    (134, "Udieresis", 0x00DC),
    (135, "aacute", 0x00E1),
    (136, "agrave", 0x00E0),
    (137, "acircumflex", 0x00E2),
    (138, "adieresis", 0x00E4),
    (139, "atilde", 0x00E3),
    (140, "aring", 0x00E5),
    (141, "ccedilla", 0x00E7),
    (142, "eacute", 0x00E9),
    (143, "egrave", 0x00E8),
    (144, "ecircumflex", 0x00EA),
    (145, "edieresis", 0x00EB),
    (146, "iacute", 0x00ED),
    (147, "igrave", 0x00EC),
    (148, "icircumflex", 0x00EE),
    (149, "idieresis", 0x00EF),
    (150, "ntilde", 0x00F1),
    (151, "oacute", 0x00F3),
    (152, "ograve", 0x00F2),
    (153, "ocircumflex", 0x00F4),
    (154, "odieresis", 0x00F6),
    (155, "otilde", 0x00F5),
    (156, "uacute", 0x00FA),
    (157, "ugrave", 0x00F9),
    (158, "ucircumflex", 0x00FB),
    (159, "udieresis", 0x00FC),
    (160, "dagger", 0x2020),
    (161, "degree", 0x00B0),
    (162, "cent", 0x00A2),
    (163, "sterling", 0x00A3),
    (164, "section", 0x00A7),
    (165, "bullet", 0x2022),
    (166, "paragraph", 0x00B6),
    (167, "germandbls", 0x00DF),
    (168, "registered", 0x00AE),
    (169, "copyright", 0x00A9),
    (170, "trademark", 0x2122),
    (171, "acute", 0x00B4),
    (172, "dieresis", 0x00A8),
    (174, "AE", 0x00C6),
    (175, "Oslash", 0x00D8),
    ...
    (180, "yen", 0x00A5),
    (181, "mu", 0x00B5),
    (187, "ordfeminine", 0x00AA),
    (188, "ordmasculine", 0x00BA),
    (190, "ae", 0x00E6),
    (191, "oslash", 0x00F8),
    (192, "questiondown", 0x00BF),
    (193, "exclamdown", 0x00A1),
    (194, "logicalnot", 0x00AC),
    (196, "florin", 0x0192),
    (199, "guillemotleft", 0x00AB),
    (200, "guillemotright", 0x00BB),
    (201, "ellipsis", 0x2026),
    (202, "space", 0x00A0),
    (203, "Agrave", 0x00C0),
    (204, "Atilde", 0x00C3),
    ...
    (208, "endash", 0x2013),
    (209, "emdash", 0x2014),
    (210, "quotedblleft", 0x201C),
    (211, "quotedblright", 0x201D),
    (212, "quoteleft", 0x2018),
    (213, "quoteright", 0x2019),
    (214, "divide", 0x00F7),
    (216, "ydieresis", 0x00FF),
    (217, "Ydieresis", 0x0178),
    (218, "fraction", 0x2044),
    (219, "currency", 0x00A4),
    (220, "guilsinglleft", 0x2039),
    (221, "guilsinglright", 0x203A),
    (222, "fi", 0xFB01),
    (223, "fl", 0xFB02),
    (224, "daggerdbl", 0x2021),
    (225, "periodcentered", 0x00B7),
    (226, "quotesinglbase", 0x201A),
    (227, "quotedblbase", 0x201E),
    (228, "perthousand", 0x2030),
    (229, "Acircumflex", 0x00C2),
    (230, "Ecircumflex", 0x00CA),
    (231, "Aacute", 0x00C1),
    (232, "Edieresis", 0x00CB),
    (233, "Egrave", 0x00C8),
    (234, "Iacute", 0x00CD),
    (235, "Icircumflex", 0x00CE),
    (236, "Idieresis", 0x00CF),
    (237, "Igrave", 0x00CC),
    (238, "Oacute", 0x00D3),
    (239, "Ocircumflex", 0x00D4),
    (241, "Ograve", 0x00D2),
    (242, "Uacute", 0x00DA),
    (243, "Ucircumflex", 0x00DB),
    (244, "Ugrave", 0x00D9),
    (245, "dotlessi", 0x0131),
    (246, "circumflex", 0x02C6),
    (247, "tilde", 0x02DC),
    (248, "macron", 0x00AF),
    (249, "breve", 0x02D8),
    (250, "dotaccent", 0x02D9),
    (251, "ring", 0x02DA),
    (252, "cedilla", 0x00B8),
    (253, "hungarumlaut", 0x02DD),
    (254, "ogonek", 0x02DB),
    (255, "caron", 0x02C7),
];
