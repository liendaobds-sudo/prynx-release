...
#[pyfunction]
pub fn sticker_solve_grid(py: Python<'_>, usable_w: f64, usable_h: f64, item_w: f64, item_h: f64, gap_x: f64, gap_y: f64) -> PyResult<Py<PyAny>> {
    let r = core::solve_grid(usable_w, usable_h, item_w, item_h, gap_x, gap_y);
    result_to_pydict(py, &r, item_w, item_h)
}

#[pyfunction]
pub fn sticker_staggered_hex(py: Python<'_>, usable_w: f64, usable_h: f64, item_w: f64, item_h: f64, gap_x: f64, gap_y: f64) -> PyResult<Py<PyAny>> {
    let r = core::staggered_hex(usable_w, usable_h, item_w, item_h, gap_x, gap_y);
    result_to_pydict(py, &r, item_w, item_h)
}

#[pyfunction]
pub fn sticker_staggered_vertical(py: Python<'_>, usable_w: f64, usable_h: f64, item_w: f64, item_h: f64, gap_x: f64, gap_y: f64) -> PyResult<Py<PyAny>> {
    let r = core::staggered_vertical(usable_w, usable_h, item_w, item_h, gap_x, gap_y);
    result_to_pydict(py, &r, item_w, item_h)
}

#[pyfunction]
pub fn sticker_hex_tiling_row(py: Python<'_>, usable_w: f64, usable_h: f64, item_w: f64, item_h: f64, gap_x: f64, gap_y: f64) -> PyResult<Py<PyAny>> {
    let r = core::hex_tiling_row(usable_w, usable_h, item_w, item_h, gap_x, gap_y);
    result_to_pydict(py, &r, item_w, item_h)
}

#[pyfunction]
pub fn sticker_hex_tiling_col(py: Python<'_>, usable_w: f64, usable_h: f64, item_w: f64, item_h: f64, gap_x: f64, gap_y: f64) -> PyResult<Py<PyAny>> {
...
pub fn sticker_cluster_grid(py: Python<'_>, usable_w: f64, usable_h: f64, item_w: f64, item_h: f64, gap_x: f64, gap_y: f64, params: Option<&Bound<'_, PyDict>>, rotated: bool) -> PyResult<Py<PyAny>> {
...
#[pyfunction]
#[pyo3(signature = (usable_w, usable_h, item_w, item_h, gap_x, gap_y, params, rotated))]
pub fn sticker_row_alternating(py: Python<'_>, usable_w: f64, usable_h: f64, item_w: f64, item_h: f64, gap_x: f64, gap_y: f64, params: Option<&Bound<'_, PyDict>>, rotated: bool) -> PyResult<Py<PyAny>> {
    let (w, h) = if rotated { (item_h, item_w) } else { (item_w, item_h) };
...
#[pyfunction]
#[pyo3(signature = (usable_w, usable_h, item_w, item_h, gap_x, gap_y, params, rotated))]
pub fn sticker_col_alternating(py: Python<'_>, usable_w: f64, usable_h: f64, item_w: f64, item_h: f64, gap_x: f64, gap_y: f64, params: Option<&Bound<'_, PyDict>>, rotated: bool) -> PyResult<Py<PyAny>> {
    let (w, h) = if rotated { (item_h, item_w) } else { (item_w, item_h) };
