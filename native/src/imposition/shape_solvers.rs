...
pub fn shape_pointy_hex(
    ...
    shape_to_pydict(
        py,
        &core::pointy_hex(usable_w, usable_h, item_w, item_h, gap_x, gap_y, is_rotated),
    )
}

#[pyfunction]
#[pyo3(signature = (usable_w, usable_h, item_w, item_h, gap_x, gap_y, is_rotated=false))]
pub fn shape_flat_hex(
    py: Python<'_>,
    usable_w: f64,
    usable_h: f64,
    item_w: f64,
    ...
    shape_to_pydict(
        py,
        &core::flat_hex(usable_w, usable_h, item_w, item_h, gap_x, gap_y, is_rotated),
    )
}

#[pyfunction]
#[pyo3(signature = (usable_w, usable_h, item_w, item_h, gap_x, gap_y, shape_props, is_rotated_90=false))]
pub fn shape_trapezoid(
    py: Python<'_>,
    usable_w: f64,
    usable_h: f64,
    item_w: f64,
...
pub fn shape_parallelogram(
    ...
    shape_to_pydict(
        py,
        &core::parallelogram(usable_w, usable_h, item_w, item_h, gap_x, gap_y, &sp),
    )
}

#[pyfunction]
pub fn shape_l_layout(
    py: Python<'_>,
    usable_w: f64,
    usable_h: f64,
    item_w: f64,
...
pub fn shape_dumbbell_pair_col(
    py: Python<'_>,
    usable_w: f64,
    usable_h: f64,
    item_w: f64,
...
#[pyfunction]
#[pyo3(signature = (usable_w, usable_h, item_w, item_h, gap_x, gap_y, big_end_axis_frac=0.65, is_rotated_90=false))]
pub fn shape_dumbbell_pair_row(
    py: Python<'_>,
    usable_w: f64,
    usable_h: f64,
    item_w: f64,
