...
pub(crate) struct StructuredResultMetrics {
    ...
    pub(crate) artifact_max_tangent_jump_degrees: f64,
    pub(crate) raster_scale: u32,
    pub(crate) iou: f64,
    pub(crate) mae: f64,
}
...
pub(crate) fn build_structured_result(
    ...
    Ok(LogoStructuredResult {
        ...
        metrics: StructuredResultMetrics {
            ...
            line_segments: profile_output.metrics.line_segments,
            cubic_segments: profile_output.metrics.cubic_segments,
            circle_count: profile_output.metrics.circle_count,
            ellipse_count: profile_output.metrics.ellipse_count,
            max_smooth_tangent_jump_degrees: profile_output.metrics.max_smooth_tangent_jump_degrees,
            artifact_max_tangent_jump_degrees: qc.max_artifact_tangent_jump_degrees,
            raster_scale: options.raster_scale,
            iou,
            mae,
        },
