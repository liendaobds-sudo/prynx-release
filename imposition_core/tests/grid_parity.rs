...
fn cases() -> Vec<(&'static str, f64, f64, f64, f64, f64, f64)> {
    vec![
        ...
        (
            "vua khit co gap lam mat mot cot",
            300.0,
            200.0,
            100.0,
            100.0,
...
fn compute(case: &(&'static str, f64, f64, f64, f64, f64, f64)) -> Expected {
    let result = solve_optimal_layout(
        case.1,
        case.2,
        case.3,
        case.4,
